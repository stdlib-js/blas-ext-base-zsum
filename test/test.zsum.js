...
tape( 'the function calculates the sum of all strided array elements', function test( t ) {
	...
	x = new Complex128Array( [ 1.0, 1.0, 1.0e100, 1.0e100, 1.0, 1.0, -1.0e100, -1.0e100 ] ); // eslint-disable-line max-len
	v = zsum( x.length, x, 1 );
	t.strictEqual( isSameComplex128( v, new Complex128( 2.0, 2.0 ) ), true, 'returns expected value' );
